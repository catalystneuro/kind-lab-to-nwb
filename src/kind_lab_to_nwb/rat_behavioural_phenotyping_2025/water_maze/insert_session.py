...
nwb_file_name = "sub-302-Arid1b(2)_ses-WM-2-Reference-Day1.nwb"
...
rg = RestrGraph(
    ...
    leaves=dict(
        ...
        restriction='nwb_file_name="sub-302-Arid1b(2)_ses-WM-2-Reference-Day1_.nwb"',  # must be a string restr
    ),
